...
| Precision@5 (всего)| XX% | На датасете `eval_questions.json` (15 вопросов с эталонными ответами) 
| Precision@5 (русский) | XX% | На русскоязычных запросах 
| Precision@5 (английский) | XX% | На англоязычных запросах 
| Latency | < X сек | Среднее на 10 последовательных запросах 
| Размер базы | XX чанков | Проиндексировано из N файлов 
...
| Интегратор | Точка входа `index.py`, `requirements.txt`, Docker Compose, документация, защита 
